...
- [x] **T41** — `/receipt` route: photo upload → `intake_receipt` → per-line review screen (needs: T20)
- [x] **T42** — Approval queue UI: pending AI proposals, approve / reject / bulk-approve (needs: T20)
